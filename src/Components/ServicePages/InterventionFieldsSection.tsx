    ...
    <section className="md:pt-20 pt-8 pb-20">
      <div className="w-full flex flex-col md:flex-row items-center justify-evenly px-6 lg:px-10 opacity-0 -translate-x-1 gap-20 md:gap-0">
        ...
        <div className="grid grid-cols-9 grid-rows-10 justify-center items-end max-w-[700px] max-h-[500px] gap-4">
          ...
          <div className="col-start-1 col-end-3 row-start-5 row-end-11 h-full w-[100%] rounded-md rounded-tr-[80px] rounded-bl-[80px] bg-main-blue"></div>
          <div className="col-start-3 col-end-8 row-start-9 row-end-11 h-full w-full rounded-md rounded-tl-[80px] rounded-br-[80px] bg-secondary-green"></div>
        </div>
      </div>
    </section>
  );
