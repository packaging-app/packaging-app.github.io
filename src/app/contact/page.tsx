            ...
            <div className="bg-white px-6 py-24 sm:py-32 lg:px-8">
                <div className="mx-auto max-w-2xl text-center opacity-0">
                    ...
                    <p className="mt-2 text-lg/8 text-gray-600">
                        Questions about our packaging solutions? Fill out our form and
                        our team will respond quickly. We&apos;re here to help!
                    </p>
                </div>
                        ...
                        <div className="opacity-0">
                            ...
                            <div className="mb-8 space-y-4">
                                <div>
                                    ...
                                    <p className="text-gray-600">Neopark de Monastir LOT 46P – Route de Sahline, Manzel Harb 5036</p>
                                </div>
                                <div>
